...
/**
 * Reset step 2: takes the OTP + a new password. Reads the target
 * identifier (email or phone) from the query string set by
 * /forgot-password. If the user landed here directly with no query
 * param, we bounce back — no way to complete the flow without
 * knowing which account we're resetting.
 */
    ...
    return (
      <div className="space-y-4">
        <p className="text-[15px] text-ink-soft">
          We couldn&apos;t find the reset context. Request a fresh code and
          try again.
        </p>
        <Button href="/forgot-password" block size="lg">
          Get a new code
        </Button>
      </div>
    );
