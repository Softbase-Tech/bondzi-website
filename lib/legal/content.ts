/**
 * Static fallback content for the public legal pages. This is the source of
 * truth that always renders (like the /partners marketing page), independent
 * of the backend. If an admin later edits the page in Admin → Legal, the page
 * prefers that copy and falls back to this. Keep in Markdown.
 */
...
- Payments are processed by **Paystack**. Refunds are handled under our Refund
  Policy, available in the app and on request.
